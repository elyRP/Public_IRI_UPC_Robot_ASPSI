  ...
  tf_listener_(ros::Duration(10.f))
{
  ...
  rear_laser_subscriber_  = public_node_handle_.subscribe("rear_scan", 100, &SafeCmdAlgNode::rear_laser_callback, this);
  front_laser_subscriber_ = public_node_handle_.subscribe("front_scan", 100, &SafeCmdAlgNode::front_laser_callback, this);
